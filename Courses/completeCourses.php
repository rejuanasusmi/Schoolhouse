<?php
    ...
    if (isset($_GET['details'])) {
        ...
        header('location:finishSingleCourse.php');
    }

    if (isset($_GET['details1'])) {        
        $course_details1 = $_GET['details1'];
        $_SESSION['cour_id2'] = $course_details1;
        //$_SESSION['teacher_id'] =   $tech_id;
        header('location:CompleteVideoPage.php');
    }
            ...
            <div id="content">
                ...
                <div class="container">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Complete Courses</h1>
                    </div>        
                    <div class="content1">
                    <div class="cards">
                        <?php
                            $select_course = mysqli_query($conn, "SELECT course_title, course_topic, image,course_id FROM courses WHERE finish_value='1' and teacher_id = '$tt_id' ") or die('query failed');
                        ...
                        <div class="card">
                            ...
                            <div class="view">
                                ...
                                <a href="completeCourses.php?details=<?php echo $fetch_course['course_id'];?>">
                                <button class="btn">Details</button>
                                </a>
                                <a href="completeCourses.php?details1=<?php echo $fetch_course['course_id'];?>">
