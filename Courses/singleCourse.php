...
<section class="Sinale-course"> 
        ...
        <div class="flex-box">
            ...
            <div class="right">
                ...
                <div class="btn-box">
                    <a href="./../UploadCourse/uploadvideo.php">
                    <button type="submit" name="Continue" class="continue-btn">Continue
                    </button></a>
                    <button type="submit" name="submit" class="finish-btn">Finish</button>
                </div>              
                </form>
            </div>
        </div>
